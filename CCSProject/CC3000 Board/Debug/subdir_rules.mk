...
board.obj: C:/ti/CurubaDevice/Source/CC3000\ Board/board.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
...
interuptDeviceControl.obj: C:/ti/CurubaDevice/Source/CC3000\ Board/interuptDeviceControl.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: MSP430 Compiler'
	"C:/ti/ccsv5/tools/compiler/msp430_4.2.1/bin/cl430" -vmspx --abi=eabi --include_path="C:/ti/ccsv5/ccs_base/msp430/include" --include_path="C:/ti/ccsv5/tools/compiler/msp430_4.2.1/include" --advice:power=all -g --define=__CCS__ --define=__MSP430F5310__ --diag_warning=225 --display_error_number --silicon_errata=CPU21 --silicon_errata=CPU22 --silicon_errata=CPU40 --printf_support=minimal --preproc_with_compile --preproc_dependency="interuptDeviceControl.pp" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
